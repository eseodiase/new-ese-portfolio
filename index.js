...
const app =()=>{
    ...
    document.querySelector(".main").innerHTML = (home() + about() + skills() + courses() + enroll() );
...
const int = document.querySelector(".intro").style.display ="none"; 
  ...
  new Swiper('.testimonials-slider', {
    ...
    {
     const skillsPage = document.querySelector(".skillsLi").onclick = function(){
    ...
    {
     const coursesPage = document.querySelector(".coursesLi").onclick = function(){
  ...
  new Swiper('.testimonials-slider', {
    ...
    {
     const enrollPage = document.querySelector(".enrollLi").onclick = function(){
    document.querySelector(".main").innerHTML = (enroll());   
    }
    }
