...
import {iframe0, iframe1, iframe2, iframe3, iframe4, iframe5, iframe6, iframe7} from "./components/portfolio.js";
...
const myApp=()=>{
 ...
 const port = document.querySelector(".ul_right").onclick = function (){
     document.querySelector(".main").innerHTML = ( iframe0() + iframe1() + iframe2() + iframe3() + iframe4() + iframe5() + iframe6() + iframe7() );
